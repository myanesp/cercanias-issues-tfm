...
# mutate(Destination = if_else(str_detect(original, pattern_destination),
#                              str_extract(original, pattern_destination),
#                              NA_character_),
#        Lines = if_else(is.na(Hashtags) & is.na(Destination),
#                        str_extract(original, pattern_lines),
#                        if_else(str_detect(Hashtags, pattern_hashtags),
#                                str_extract(Hashtags, pattern_hashtags),
#                                str_extract(Destination, "(?<=dirección|destino)\\s+\\w+")))) %>%
...
text <- "tren con direccion Aranjuez tus muertos"
